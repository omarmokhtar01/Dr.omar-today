   ...
   background:'linear-gradient(331.41deg, #D19B6F 6.78%, #F6E5C3 204.87%)'}}>
    ...
    <Container>
       <Row className='me-auto'  md={4}>
        ...
        <Col>
        <div style={{display:'flex' , justifyContent:'center' , alignItems:'center' , padding:'15px' ,  gap:'5px'}}>
              
                 <RiDeleteBin5Line style={{ fontSize:'25px', color:'gray'}}/>
              
                 <IoHeartCircleSharp style={{ color: '#878787bd', fontSize: '25px' ,  cursor: "pointer"}} />
                 <FaCirclePlay style={{ color: 'rgb(209, 155, 111)', fontSize: '26px' }}/> 
               </div></Col>
       </Row>
