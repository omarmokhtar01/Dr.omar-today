     ...
     <Container >
      <Row class="row row-cols-2 row-cols-lg-4 g-2 g-lg-3" style={{margin:'35px'}}  >
        <Col >
             ...
             <RiDeleteBin5Line style={{ fontSize:'35px', color:'gray', padding:'5px',position:'absolute' , zIndex:'2' , margin:'15px'
             , border:'1px solid #FFFFFF' , borderRadius:'25px', background:'#FFFFFF'}}/>
