    ...
    <Row>
        <Col>
          <div style={{position:'relative' , marginTop:'-35px'}}>
            <h1 style={{color: 'rgba(255, 255, 255, 1)' , fontWeight:'500' , paddingBottom :'25px', paddingTop:'15px' , borderRadius:'25px'}} className=" background-image"> الملف الشخصي  </h1>
          </div>
        </Col>
    </Row>
    </Container>
    ...
    <Container className='d-flex justify-content-center align-items-center' >
      <Row className="m-3">
        <Col xs="6" md="6" lg="6" style={{ textAlign: 'center', marginBottom: '10px' }}>
         ...
         <div style={{border :'none' , borderRadius:'23px' , width:'178px' , height:'33.74px' , 
            background:'linear-gradient(331.41deg, #D19B6F 6.78%, #F6E5C3 204.87%)' }} className='personal-box'>
        ...
        <div style={{border :'2px solid rgba(232, 232, 232, 1)' , borderRadius:'23px' , width:'178px' , height:'33.74px' , 
               background:'linear-gradient(0deg, #E8E8E8, #E8E8E8),linear-gradient(0deg, #F5F5F5, #F5F5F5)' }} className='personal-box' >
...
<img  className='icon-input' src={phone} alt="" style={{position:'absolute' , display:'flex' , marginTop:'17px',paddingRight:'9px' }} />
            <button style={{position:'absolute', margin:'13px 100px 13px 13px' , borderRadius:'15px' 
            , background:'linear-gradient(331.41deg, #D19B6F 6.78%, #F6E5C3 204.87%)' , border:'none', padding:'3px 20px',
            color:'#FFFFFF'}} className='active-button' >تفعيل</button>
</div>
     ...
     <div  className='d-flex justify-content-center align-items-center' style={{borderRadius:'30px' }} >
          <Button style={{ color:' rgba(229, 25, 55, 1)' , fontSize :'20px'  , fontWeight:'600'}} 
            className='deleteButton ' onClick={() => setSmShow(true)}    >حذف الحساب</Button>
      </div>
      ...
      <Modal.Body  style={{backgroundColor:' rgb(237, 234, 234)' , borderRadius:'15px'}}  >
        <div >
          <div style={{display:'flex' , flexDirection:'column' , justifyContent:'center' , alignItems:'center' , margin:'15px'}}  >
            <div>  <img src={deleteAcc} style={{paddingBottom:'5px'}}   alt=''/></div>
        
            <h5 style={{color:'rgba(255, 53, 53, 1)'}} >  حذف الحساب  </h5>
            <p style={{color:'rgba(122, 128, 138, 1)' , fontSize:'19px' , textAlign:'center'}}>
              يرجى ملاحظة أنه عند حذف الحساب
        ...
        <div  className='d-flex justify-content-center align-items-center' style={{borderRadius:'30px' }} >
           <button style={{ color:' rgba(255, 255, 255, 1)' , fontWeight:'700' , fontSize :'20px' , paddingTop:'2px'
            , border:'none'}} className='profileButton' >حذف الحساب</button>
        </div>
            ...
            <div  className='d-flex justify-content-center align-items-center' style={{borderRadius:'30px' }} >
              <button style={{ color:' rgba(255, 255, 255, 1)' , fontWeight:'700' , fontSize :'25px' , border:'none'}} className='profileButton' >حفظ</button>
            </div>
