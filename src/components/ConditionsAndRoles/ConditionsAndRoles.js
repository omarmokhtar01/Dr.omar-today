...
const ConditionsAndRoles = () => {
    ...
    <Row>
        <Col>
          <div style={{position:'relative' , marginTop:'-35px'}}>
            <h1 style={{color: 'rgba(255, 255, 255, 1)' , fontWeight:'500' , paddingBottom :'25px', paddingTop:'15px' , borderRadius:'25px'}} className=" background-image">الشروط والاحكام  </h1>
          </div>
        </Col>
    </Row>
    </Container>
    ...
    <Container>
        <Row>
            ...
            <h5 style={{color:'rgba(4, 32, 48, 1)' , marginTop:'10px' , fontWeight:'700'}}>ملفات الدخول</h5>

            <div  className='d-flex justify-content-center align-items-center'>

            <p style={{margin:'10px 75px 15px 75px' , color :'rgba(99, 98, 112, 1)' , lineHeight:'26.73px' , width:'85'}}>كالعديد من المواقع الأخرى، تستخدم منصة هداية سجلات الدخول (log files). وتتضمن المعلومات التي نجمعها في هذه السجلات عنوان الإنترنت (IP Address)، 
            ...
            <h5 style={{color:'rgba(4, 32, 48, 1)' , marginTop:'10px' , fontWeight:'700'}}> الكوكيز</h5>
            ...
            <h5 style={{color:'rgba(4, 32, 48, 1)' , marginTop:'10px' , fontWeight:'700'}}> الأطراف الثالثة</h5>
            ...
            <h5 style={{color:'rgba(4, 32, 48, 1)' , marginTop:'10px' , fontWeight:'700'}}> تسجيل الدخول عن طريق الشبكات الاجتماعية </h5>
          ...
          <div  className='d-flex justify-content-center align-items-center'>
           ...
           <h5 style={{color:'rgba(4, 32, 48, 1)' , marginTop:'10px' , fontWeight:'700'}}> روابط المنصة إلى مواقع إلكترونية خارجية</h5>
        ...
        قد تحتوي منصة هداية على روابط إلى مواقع إلكترونية للغير كمزودي محتوى آخرين وبعض مزودي الخدمات، غير أن هذه المواقع الأخرى ليست تحت إدارتنا وبذلك عليك أن تتفهم وتوافق على أننا لا نتحمل مسؤولية جمع هذه المواقع واستخدامها لمعلوماتك ما لم تتم الإشارة له بغير ذلك في سياسة الخصوصية هذه. نوصيكم بالحرص عندما يتم توجيهكم إلى موقع الغير لتقوموا بمراجعة سياسات الخصوصية لكل موقع تزورونه وتستخدمونه.
            ...
            <h5 style={{color:'rgba(4, 32, 48, 1)' , marginTop:'10px' , fontWeight:'700'}}> تغييرات سياسة الخصوصية</h5>
